...
namespace SMOWMS.UI.AssetsManager
{
    partial class frmAssSalesOrderCreate : Smobiler.Core.Controls.MobileForm
    {
        ...
        private void btnSave_Press(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Rows.Count != 0)
                {
                    ...
                    ReturnInfo returnInfo = _autofacConfig.AssSalesOrderService.AddSalesOrder(assSalesOrderInput);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frmAssSalesOrderCreate_Load(object sender, EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frmAssSalesOrderCreate_KeyDown(object sender, KeyDownEventArgs e)
        {
