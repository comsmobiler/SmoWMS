...
namespace SMOWMS.UI.Analyze.Consumable
{
    ...
    {
        public frmPurchaseAnalyze() : base()
        {
        ...
        /// <param name="e"></param>
        private void frmPurchaseAnalyze_Load(object sender, EventArgs e)
        {
        ...
        public void Bind()
        {
            ...
            Dictionary<string, decimal> result = autofacConfig.ConPurchaseOrderService.GetPurchaseAnalyze(dpStart.Value, dpEnd.Value);
