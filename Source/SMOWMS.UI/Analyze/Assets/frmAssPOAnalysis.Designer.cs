...
{
    partial class frmAssPOAnalysis : Smobiler.Core.Controls.MobileForm
    {
        ...
        "详情"};
            ...
            this.KeyDown += new Smobiler.Core.Controls.KeyDownEventHandler(this.frmAssPOAnalysis_KeyDown);
            this.Load += new System.EventHandler(this.frmAssPOAnalysis_Load);
            this.Name = "frmAssPOAnalysis";
